...
public class ProductController {
    ...
    @GetMapping
    public ResponseEntity<List<Product>> getAllProducts(@RequestParam(required = false) Map<String, String> filters) {
        return new ResponseEntity<>(productService.findAllProducts(filters),HttpStatus.OK);
    }
